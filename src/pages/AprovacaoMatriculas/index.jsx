...
import { MATRICULA_STATUS, MATRICULA_STATUS_LABEL } from '../../constants';
                    ...
                    {loading ? (
                        ...
                        matriculas.map(m => (
                            <tr key={m.id}>
                                ...
                                <td>
                                    <span style={{
                                        backgroundColor: m.status === MATRICULA_STATUS.CONCLUIDO
                                            ? 'rgba(39,174,96,0.1)'
                                            : 'rgba(243,156,18,0.1)',
                                        color: m.status === MATRICULA_STATUS.CONCLUIDO
                                            ? '#27ae60'
                                            : '#f39c12',
                                        padding: '4px 8px',
                                        borderRadius: '4px',
                                        ...
                                        {MATRICULA_STATUS_LABEL[m.status] ?? m.status}
                                    </span>
                                </td>
                                <td>
            ...
            >
                {selectedMatricula && (
                    <div>
                        ...
                        {selectedMatricula.status === MATRICULA_STATUS.ANALISE_COORD && (
                        ...
                        {selectedMatricula.status === MATRICULA_STATUS.ANALISE_PIX && (
                        ...
                        {selectedMatricula.status === MATRICULA_STATUS.AGUARDANDO_PAGAMENTO && (
                        ...
                        {selectedMatricula.status !== MATRICULA_STATUS.AGUARDANDO_PAGAMENTO &&
                         selectedMatricula.status !== MATRICULA_STATUS.CONCLUIDO && (
